...
# Initialize RSA keys
(public_key, private_key) = rsa.newkeys(2048)  # Using 512 bits for demo purposes; for real applications, consider 2048 or higher.
public_partner = None

# Server and Client socket
server = None
client = None
connected_client_socket = None  # Keep track of the connected client socket
